...
- **Chat intent routing — built 2026-09-26** (`leetsage-chat-intent-routing`,
  branch `feature/chat-intent-routing`, off spec `8dae03f`; **local — not
  committed yet, pending review**): the last pre-launch feature and the resolution
...
- **Next to build:** the deferred eval follow-up (real captured responses + a
  validated LLM-as-judge — the injection work names this as its next step too),
